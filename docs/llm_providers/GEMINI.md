...
-   [x] **4.4: Write Tests**
    -   [x] Install `pytest`.
    -   [x] Write unit tests for key functions (`extract_text`, `classify_document`).
...
-   [x] **5.2: Finalize All Documentation**
